    ...
    content: (
        <>
            <div>
                ...
                <p><ImageWithShadow noShadow src={pla.fomula1$png} caption='Fomula.1' /></p>
                <p>From the above, the probability of B under the condition that A occurs is</p>
                <p><ImageWithShadow noShadow src={pla.fomula2$png} caption='Fomula.2' /></p>
                <p>The generalized Bayesian probability is</p>
                <p><ImageWithShadow noShadow src={pla.fomula3$png} caption='Fomula.3' /></p>
                <h3>2. Assumptions</h3>
                ...
                <h3>1. Variables</h3>
                <p><ImageWithShadow noShadow src={pla.table1$png} caption='Table.1: The variables of model' /></p>
                <h3>2. Parameters</h3>
                <p><ImageWithShadow noShadow src={pla.table2$png} caption='Table.2: The parameters of model' /></p>
                ...
                <p><ImageWithShadow noShadow src={pla.fomula4$png} /></p>
                <p><ImageWithShadow noShadow src={pla.fomula5$png} caption='Fomula.4' /></p>
                <H2>Ⅴ. Result</H2>
                ...
                <p><ImageWithShadow noShadow src={pla.fomula6$png} /></p>
                <p>The mathematical expectation of the population of Enterococcus faecalis after sterilization :</p>
                <p><ImageWithShadow noShadow src={pla.fomula7$png} /></p>
