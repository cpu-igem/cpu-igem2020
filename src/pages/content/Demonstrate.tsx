   ...
   content: (
      <>
         <div>
            ...
            <p><ImageWithShadow src={de.Figure1$png} caption="Figure1. Comparison of Corrected A450 of Sample Groups.（fusion protein）" /></p>
            ...
            <p><ImageWithShadow src={de.Figure2$png} caption="Figure 2. Comparison of Corrected A450 of Sample Groups.（Hiracin JM79）" /></p>
            ...
            <p><ImageWithShadow src={de.Figure3$png} caption="Figure 3. bactericidal curves" /></p>
            ...
            <p><ImageWithShadow src={de.Figure4$png} caption="Figure 4. Comparison of absorbance among experimental groups" /></p>
            <p><ImageWithShadow src={de.Figure5$png} caption="The effect of IPTG concentration on the production of IL-22" /></p>
...
We examined the TNF-α reducing efficacy of IL-22 standard samples and the culture supernatant of our engineered bacteria which contains secreted IL-22 protein for a concentration about 5ng/ml (analyzed by ELISA test) . According to the data obtained, both IL-22 standard samples and IL-22 secreted by our engineered bacteria significantly inhibited the production of TNF-α of M1 Macrophage. Statistical significance is observed between negative control group and both experimental groups(<strong>Figure 6</strong>).</p>
            <p><ImageWithShadow src={de.Figure6$png} caption="Figure 6. Comparison of the levels of TNF-α produced by different groups." /></p>
            <p><ImageWithShadow src={de.Figure7$png} caption='Figure 7. When the amount of LPS increased, the corresponding TNF-α expression also increased significantly' /></p>
