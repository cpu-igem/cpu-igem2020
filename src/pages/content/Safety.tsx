    ...
    content: (
      <>
            <div>
                ...
                <h2>Safety part</h2>
                <p>As an engineered bacteria placed in human intestine, it should be exterminated once escape from the patient&#39;s body. Many conditions for inducing suicide have been considered, such as pH, light and so on. Eventually, temperature is selected as an ideal condition for it is widely suitable. Thus, Part:BBa_K3036004, designed by BNU-China【跳转至 <Link href='http://parts.igem.org/Part:BBa_K3036004#cite_ref-1'>http://parts.igem.org/Part:BBa_K3036004#cite_ref-1</Link>】 is utilized in our project to avoid the possible pollution from engineered bacteria.</p>
                ...
                <p><ImageWithShadow noShadow src={sf.safetyFig1$coldTriggeredkillswitch$png} caption="safety-fig1.cold-triggered kill switch"/></p>
                    <p>Figure 1. Cold-triggered kill switch</p>
                    ...
                    <p> <ImageWithShadow noShadow src={sf.SafetyFigure2Flammableliquidstoragecabinet$jpg} caption="Safety-Figure 2-flammable liquid storage cabinet"/></p>
                        <p><ImageWithShadow noShadow src={sf.SafetyFigure2Uniforms$jpg} caption="Figure 2. Generally security assurance"/></p>
                            ...
                            <p><ImageWithShadow noShadow src={sf.safetyFigure3Zzy$jpg} caption="Figure 3. Masks, gloves and lab coats"/></p>
                                ...
                                <p>General biosafety standard for causative bacteria laboratories<Link href='http://www.nhc.gov.cn/ewebeditor/uploadfile/2017/07/20170727145700597.pdf'>http://www.nhc.gov.cn/ewebeditor/uploadfile/2017/07/20170727145700597.pdf</Link></p>
                                <p>General biosafety standard for microbiological and biomedical laboratories
<Link href='http://www.nhc.gov.cn/ewebeditor/uploadfile/2014/12/20141217161248966.pdf'>http://www.nhc.gov.cn/ewebeditor/uploadfile/2014/12/20141217161248966.pdf</Link></p>
                                <h2>Safety in HP</h2>
