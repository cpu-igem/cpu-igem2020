   ...
   content: (
      <>
         <div>
            ...
            <h2>Inhibiting local inflammation in liver:  PalcA and the expression of IL-22</h2>
            ...
            <p><ImageWithShadow noShadow src={sign.fig1$IL1$png} caption="Figure 1. PalcA and the expression of IL-22" /></p>
            ...
            <p><ImageWithShadow noShadow src={sign.fig2$png} caption="Figure 2. T7 transcription system is applied to amplify the upstream signal of PalcA" /></p>
            <h2>Killing Enterococcus faecalis in the intestine:  quorum sensing and bacteriocin </h2>
            <p><em>Enterococcus faecalis</em> is proved as a pathogenic bacteria to alcoholic liver disease (ALD)<sup>[14]</sup>. In this study, phages are used to kill <em>E. faeculis</em>, but it has narrow scope of application in killing <em>E.faeculis</em> .In order to achieve effective control of the density of <em>Enterococcus faecalis</em> in the intestine, three bacteriocins, hiracin JM79, Plwα and Plwβ, were applied as output of <em>Enterococcus faecalis</em> killing system. The bacteriocins are all effective for killing <em>Enterococcus faecalis</em> acting alone <sup>[15.16.17]</sup>.A secretion label, YebF, was fused to each bacteriocin, so that they can be secreted and exhibit germicidal effect in intestine<sup>[18]</sup>.</p>
            <p>In order to protect other microorganisms in the intestine, we hoped the bacteriocins only be released at the present of <em>E. faeculis</em>. Quorum sensing, a mechanism commonly applied in antibacterial project, can enable the host to execute specified commands under specific circumstances. We then conceived a system where the release of bacteriocins was regulated by quorum sensing system of <em>Enterococcus faecalis</em>, so that these peptides would only be released in the presence of <em>Enterococcus faecalis</em>. </p>
            <p><ImageWithShadow noShadow src={sign.fig3$png} caption="Figure 3. quorum sensing and bacteriocin" /></p>
            ...
            <p><ImageWithShadow noShadow src={sign.fig4l$png} caption="Figure 4. Enterococcus faecalis quorum sensing" /></p>
            <h4>Reference:</h4>
