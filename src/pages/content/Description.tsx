   ...
   content: (
      <>
         <div>
            ...
            <H2>FIRST GLANCE AT THE VERY PROBLEM</H2>
            ...
            <p>In this research, scholars made a breaking discovery that Enterococcus faecalis, which has always been regarded as an important kind of probiotic in human intestines, was found to be a main contributor to liver inflammation. The density of E.faecalis in the intestine would increase aberrantly in the presence of alcohol, disturbing the balance of intestinal flora. More importantly, the over-reproduced E.faecalis would secrete a kind of toxic protein called cytolysin, which would enter the bloodstream then reach the liver and cause the lysis of hepatocyte. High concentration of alcohol would also produce wounds on the intestinal wall, make it possible for even E.faecalis to enter the bloodstream. E.faecalis would get to liver first due to First Pass Effect and colonized some part of liver, thus create wounds on liver and at the same time induce local inflammation on liver, further exacerbate the damage.   </p>
            <p>Based on these researches, we reshaped our project, taking E.faecalis density control and balancing intestinal flora as our new goal, and secretion of anti-inflammation cytokine IL-22 as another aim function to achieve.</p>
            ...
            <DocOrderedList items={[
               <p>Secreting bacteriocins JM79, plwα, plwβto reduce the aberrantly high E.faecalis density in intestines, these three bacteriocins selected all have high specificity towards E.faecalis. The expression of bacteriocins is controlled by quorum sensing system, which further enhances the specificity of our system.</p>,
