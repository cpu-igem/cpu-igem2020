...
export const body = {
   ...
   content: (
      <>
         <div>
            <h1>YebF-Hiracin JM79-flag</h1>
            <H2>Part:BBa_K3661005</H2>
            <p>This composite part is composed of secretion peptide YebF, bacteriocin Hiracin JM79 and fusion tag FLAG. Peptide YebF is added to achieve the secretion of bacteriocin Hiracin JM79 into intestinal environment or culture supernatant. YebF secretion system is widely used in E.coli. [1] Hiracin JM79 has been tested and reported to have activity against <em>enterococcus faecalis</em>.[2] A major advantage of the Hiracin JM79 as an antimicrobial agent is its specificity compared to many traditional antibiotics.</p>
            <H2>Usage</H2>
            ...
            <p><ImageWithShadow noShadow src={ip.fig1$png} caption='Figure.1: Standard curve of flag protein'/></p>
            ...
            <p><ImageWithShadow noShadow src={ip.fig3$png} caption="Figure3.Comparison of Corrected A450 of Sample Groups." /></p>
            ...
            <p><ImageWithShadow noShadow src={ip.fig4$png} caption="Figure4.The killing assay of E.faecalis by JM79." /></p>



            <h1>YebF-IL22</h1>
            <H2>Part:BBa_K3661007</H2>
            ...
            <p><ImageWithShadow src={com.Fig1$Design$png} caption='Figure 1. Diagram for human IL-22 expressing and secreting in pET-28a(+) plasmid.' /></p>
            <p><strong></strong> </p>
            ...
            <p><ImageWithShadow src={com.Fig2$plasmid$png} caption='Figure 2. Full sequence mapping of pET-28a(+) plasmid.' /></p>
            ...
            <p><ImageWithShadow noShadow src={ip.figure1$png} caption="Fig1. Experiment result" /></p>
            ...
            <p><ImageWithShadow noShadow src={ip.figure2$png} caption="Fig2. IL-22 standard curve" /></p>
            ...
            <p><ImageWithShadow noShadow src={ip.figure3$png} caption="Figure 3.Comparison of Corrected A450 of Sample Groups." /></p>
            ...
            <p><ImageWithShadow noShadow src={ip.figure4$png} caption="Figure 4.Comparison of the levels of TNF-α produced by different groups." /></p>
