...
export const body = {
    ...
    content: (
        <>
            <div>
                <h1>Improved Part</h1>
                {/* <h2><Link href='http://parts.igem.org/wiki/index.php?title=Part:BBa_K3661006'> Part:BBa_K3661006</Link></h2> */}
                <H2>JTi2(NF-κb induced promoter)</H2>
                <h3><Link href='http://parts.igem.org/wiki/index.php?title=Part:BBa_K3661006'>Part:BBa_K3661006</Link></h3>
                ...
                <p><ImageWithShadow noShadow src={ip.fig3$png} caption='Table 1.Preparation Method of p-nitrophenol(P-NP) Standard Curve' /></p>
                <p><ImageWithShadow noShadow width="60%" src={ip.fig1$png} caption='Figure 1.p-NP standard curve' /></p>
                <p><ImageWithShadow noShadow width="40%" src={ip.fig2$png} caption='Figure 2.promoter efficiency of promoter JTi2' /></p>
